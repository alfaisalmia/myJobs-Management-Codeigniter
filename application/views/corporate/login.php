<div class="container">
    <div class="single">  
        <div class="form-container">
            ...
            ?>
            <form action="<?php echo base_url() ?>corporate/login" method="post">
                ...
                <div class="row">
                    <div class="form-actions floatleft">
                        ...
                        You have don't register click here <a href="<?php echo base_url() ?>corporate/register" value='register' class="btn btn-primary btn-sm">Register</a>
                    </div>
                </div>
            </form>
        </div>
