<div class="container">
    <div class="single">  
        <div class="col-sm-12 follow_left">
            <h3>View Education | <a href="<?php echo base_url(); ?>seeker/education" class="btn btn-info">Add Education</a></h3>
            ...
            <div class="follow_jobs">
                ...
                foreach ($allIndustry as $lok) {
                    ...
                    <a class="fa fa-edit" href="<?php echo base_url() . "seeker/education-edit/{$lok->id}" ?> ">Edit</a>
                    <a  href="<?php echo base_url() . "seeker/education-delete/{$lok->id}" ?>">Delete</a>
                    <?php
                }
                ?>
