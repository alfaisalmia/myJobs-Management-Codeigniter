<div class="container">
    <div class="single">  
        <div class="form-container">
            <h2>Academic Qualification Edit | <a class="btn btn-info" href="<?php echo base_url() ?>seeker/profile">profile</a></h2>
            <?php
            foreach ($allAcap as $academic){
            ?>

            <form action="<?php echo base_url() ?>seeker/qualification_update" method="post" enctype="multipart/form-data">
